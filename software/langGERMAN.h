...
const unsigned char HelpCalibration_str[] PROGMEM = {
    'U', 'n', 'k', 'a', 'l', 'i', 'b', 'r', 'i', 'e', 'r', 't', '!'
#ifndef SHORT_UNCAL_MSG
    ,
    ' ', 'Z', 'u', 'm', LCD_CHAR_INSEP, 'K', 'a', 'l', 'i', 'b', 'r', 'i', 'e',
    'r', 'e', 'n', ' ',

    'k', 'l', 'e', 'm', 'm', 'e', ' ', '3', LCD_CHAR_INSEP, 'P', 'i', 'n', 'n',
    'e', ' ', 'z', 'u', 's', 'a', 'm', 'm', 'e', 'n', ' ', 'u', 'n', 'd', ' ',
    ...
    'K', 'o', 'n', 'd', 'e', 'n', 's', 'a', 't', 'o', 'r', ' ', 'm', 'i', 't',
    ' ', 'm', 'e', 'h', 'r', ' ', 'a', 'l', 's', ' ', '1', '0', '0', 'n', 'F',
    ' ',

    'a', 'n', ' ', 'P', 'i', 'n', LCD_CHAR_INSEP, '1', LCD_CHAR_INSEP, '+',
    LCD_CHAR_INSEP, '3', ' ', 'a', 'n', '.', ' ',
#endif
    'S', 'o', 'f', 't', 'w', 'a', 'r', 'e', ' ', 'u', 'n', 'd', ' ',

    'D', 'o', 'k', 'u', 'm', 'e', 'n', 't', 'a', 't', 'i', 'o', 'n', ' ', 'i',
    's', 't', ' ', 'a', 'u', 'f', ' ', 's', 'v', 'n', ':', '/', '/', ' ',
