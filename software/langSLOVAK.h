...
const unsigned char FULLCHECK_str[] MEM2_TEXT =
    "Plna kalibracia"; //"Samotestovanie";
...
const unsigned char HelpCalibration_str[] PROGMEM = {
    '>', 'N', 'e', 'k', 'a', 'l', 'i', 'b', 'r', 'o', 'v', 'a', 'n', 'y', '!',
    '<'
#ifndef SHORT_UNCAL_MSG
    ,
    ' ', 'P', 'r', 'e', ' ', 'k', 'a', 'l', 'i', 'b', 'r', 'o', 'v', 'a', 'n',
    'i', 'e', ' ',

    's', 'p', 'o', 'j', ' ', 'v', 's', 'e', 't', 'k', 'y', ' ', '3', ' ', 'm',
    'e', 'r', 'a', 'c', 'i', 'e', ' ', 's', 'o', 'n', 'd', 'y', ' ', 'a', ' ',

    's', 't', 'l', 'a', 'c', ' ', 't', 'l', 'a', 'c', 'i', 't', 'k', 'o', ' ',
    'T', 'E', 'S', 'T', '.', ' ', 'K', 'a', 'l', 'i', 'b', 'r', 'a', 'c', 'i',
    'u', ' ',

    'p', 'o', 't', 'v', 'r', 'd', ' ', 's', 't', 'l', 'a', 'c', 'e', 'n', 'i',
    'm', ' ', 't', 'l', 'a', 'c', 'i', 't', 'k', 'a', ' ', 'T', 'E', 'S', 'T',
    ' ',

    'n', 'a', LCD_CHAR_INSEP, '2', 's', '.', ' ', 'N', 'a', ' ', 'v', 'y', 'z',
    'v', 'u', ' ', '"', 'O', 'd', 'p', 'o', 'j', ' ', 's', 'o', 'n', 'd', 'y',
    '!', '"', ' ',
    ...
    '3' + TP_OFFSET, ' ', '>', '1', '0', '0', 'n', 'F', '"', ' ',

    'p', 'r', 'i', 'p', 'o', 'j', ' ', 'm', 'e', 'd', 'z', 'i', ' ', 's', 'o',
    'n', 'd', 'y', ' ', '1', ',', '3', ' ', 'd', 'o', 'b', 'r', 'y', ' ',

    'k', 'o', 'n', 'd', 'e', 'n', 'z', 'a', 't', 'o', 'r', ' ', 'v', 'a', 'c',
    's', 'i', ' ', 'a', 'k', 'o', ' ', '1', '0', '0', 'n', 'F', '.', ' ',

    'S', 'o', 'f', 't', 'w', 'a', 'r', 'e', ' ', 'a', ' ', 'd', 'o', 'k', 'u',
    'm', 'e', 'n', 't', 'a', 'c', 'i', 'a', ' ',
