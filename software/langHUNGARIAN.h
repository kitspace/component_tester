...
const unsigned char HelpCalibration_str[] PROGMEM = {
    ...
    't', 'h', 'e', ' ', 'm', 'e', 's', 's', 'a', 'g', 'e', ' ', '"', '1',
    LCD_CHAR_LINE1, LCD_CHAR_CAP, LCD_CHAR_LINE1, '3', LCD_CHAR_INSEP, '>', '1',
    '0', '0', 'n', 'F', '"', ' ',

    'i', 's', LCD_CHAR_INSEP, 's', 'h', 'o', 'w', 'n', '.', ' ', 'S', 'o', 'f',
    't', 'w', 'a', 'r', 'e', ' ', 'a', 'n', 'd', ' ',
