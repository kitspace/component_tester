...
const unsigned char TestFailed1[] MEM_TEXT = {
    'C', 'o',       'm', 'p', 'o', 's', '.', ' ',
    'd', Fr_e_aigu, 'f', 'e', 'c', 't', '.', 0};
const unsigned char Detected[] MEM_TEXT = {' ', 'd', Fr_e_aigu, 't', Fr_e_aigu,
                                           'c', 't', 'e',       0};
const unsigned char TestTimedOut[] MEM_TEXT = {'T', 'e', 'm',       'p', 's',
                                               ' ', 'd', Fr_e_aigu, 'p', 'a',
                                               's', 's', Fr_e_aigu, '!', 0};
...
const unsigned char SELECTION_str[] MEM2_TEXT = {
    'S', Fr_e_aigu, 'l', 'e', 'c', 't', 'i', 'o', 'n', ':', 0};
const unsigned char TESTER_str[] MEM2_TEXT = "Transistor";
#ifndef NO_FREQ_COUNTER
const unsigned char FREQ_str[] MEM2_TEXT = {'F', 'r', Fr_e_aigu, 'q', 'u',
                                            'e', 'n', 'c',       'e', 0};
...
const unsigned char HFREQ_str[] MEM2_TEXT = {'F', 'r', Fr_e_aigu, 'q', 'u', 'e',
                                             'n', 'c', 'e',       ' ', '>', ' ',
                                             '2', 'M', 'H',       'z', 0};
...
const unsigned char HelpCalibration_str[] PROGMEM = {
    'N', 'o', 'n', ' ', 'c', 'a', 'l', 'i', 'b', 'r', Fr_e_aigu, '!', ' ', ' ',
    ' '
#ifndef SHORT_UNCAL_MSG
    ,
    ' ', 'P', 'o', 'u', 'r', LCD_CHAR_INSEP, 'c', 'a', 'l', 'i', 'b', 'r', 'a',
    't', 'i', 'o', 'n', ' ',

    's', 't', 'r', 'a', 'p', 'p', 'e', 'r', ' ', 'l', 'e', 's', ' ', 'p', 'i',
    'n', 's', LCD_CHAR_INSEP, '1', '2', '3', ' ',
    //'c','l','a','m','p',' ','t','h','e','
    //','3',LCD_CHAR_INSEP,'p','i','n','s',' ',
    ...
    'D', Fr_e_aigu, 'c', 'o', 'n', 'n', 'e', 'c', 't', 'e', 'r', ' ', 'l', 'e',
    's', ' ',
    //'D','i','s','c','o','n','n','e','c','t',' ',
    'b', 'r', 'o', 'c', 'h', 'e', 's', ' ', 'a', 'p', 'r', Fr_e_grave, 's', ' ',
    'l', '\'', 'a', 'f', 'f', 'i', 'c', 'h', 'a', 'g', 'e', ' ', 'd', 'u', ' ',
    'm', 'e', 's', 's', 'a', 'g', 'e', ' ',
    //'p','i','n','s',' ','a','f','t','e','r',' ',
    '"', 'i', 's', 'o', 'l', 'e', 'r', ' ', 'l', 'e', 's', ' ', 'b', 'r', 'o',
    'c', 'h', 'e', 's', '!', '"', ' ',
...
//'i','s',' ','s','h','o','w','n',
    ...
    ' ', 'e', 't', ' ',
    //' ','a','n','d',' ',
    'c', 'o', 'n', 'n', 'e', 'c', 't', 'e', 'r', ' ', 'u', 'n', ' ', 'b', 'o',
    'n', ' ',
    //'c','o','n','n','e','c','t',' ','a',' ','g','o','o','d',' ',
    'c', 'o', 'n', 'd', 'e', 'n', 's', 'a', 't', 'e', 'u', 'r', ' ', 'd', '\'',
    'a', 'u', ' ', 'm', 'o', 'i', 'n', 's', ' ',
    //'c','a','p','a','c','i','t','o','r',' ','w','i','t','h',' ',
    '1', '0', '0', 'n', 'F', ' ',
    //'a','t',' ','l','e','a','s','t',' ','1','0','0','n','F',' ',
    'a', 'u', 'x', ' ', 'p', 'i', 'n', LCD_CHAR_INSEP, '1', LCD_CHAR_INSEP, 'e',
    't', LCD_CHAR_INSEP, '3', ' ', 's', 'e', 'u', 'l', 'e', 'm', 'e', 'n', 't',
    ' ', 'a', 'p', 'r', Fr_e_grave, 's', ' ',
    //'t','o','
    //','p','i','n',LCD_CHAR_INSEP,'1',LCD_CHAR_INSEP,'a','n','d',LCD_CHAR_INSEP,'3','
    //',
    //'o','n','l','y',' ','a','f','t','e','r',' ',
...
//'i','s',LCD_CHAR_INSEP,'s','h','o','w','n','.',' ',
    ...
    'S', 'o', 'f', 't', 'w', 'a', 'r', 'e', ' ', 'e', 't', ' ', 'd', 'o', 'c',
    'u', 'm', 'e', 'n', 't', 'a', 't', 'i', 'o', 'n', ' ',
    //'i','s',' ','a','t',' ','s','v','n',':','/','/',' ',
    's', 'o', 'n', 't', ' ', 'c', 'h', 'e', 'z', ' ', 's', 'v', 'n', ':', '/',
    '/', ' ', 'm', 'i', 'k', 'r', 'o', 'c', 'o', 'n', 't', 'r', 'o', 'l', 'l',
    'e', 'r', '.', ' ',
