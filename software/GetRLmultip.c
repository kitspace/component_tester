...
// 1150  1175  1200  1225  1250  1275  1300  1325  1350  1375  1400  mV
// uint16_t RLtab[] MEM_TEXT =
...
#define RL_Tab_Length 1100 // length of table is 1400-300
  ...
  return (((y1 - y2) * tabres + (RL_Tab_Abstand / 2)) / RL_Tab_Abstand +
          y2); // interpolate table
}
