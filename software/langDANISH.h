...
const unsigned char HelpCalibration_str[] PROGMEM = {
    'U', 'k', 'a', 'l', 'i', 'b', 'r', 'e', 'r', 'e', 't', '!'
#ifndef SHORT_UNCAL_MSG
    ,
    ' ', 'T', 'i', 'l', LCD_CHAR_INSEP, 'k', 'a', 'l', 'i', 'b', 'r', 'e', 'r',
    'i', 'n', 'g', ' ',

    'k', 'l', 'e', 'm', ' ', 'd', 'e', ' ', '3', LCD_CHAR_INSEP, 'p', 'i', 'n',
    'd', 'e', ' ', 's', 'a', 'm', 'm', 'e', 'n', ' ', 'o', 'g', ' ',

    's', 't', 'a', 'r', 't', ' ', 'm', 'e', 'd', ' ', 't', 'a', 's', 't', 'e',
    't', 'r', 'y', 'k', '.', ' ',

    'B', 'e', 'k', 'r', 'æ', 'f', 't', ' ', 's', 'e', 'l', 'v', 't', 'e', 's',
    't', 'e', 'n', ' ', 'm', 'e', 'd', ' ',

    't', 'a', 's', 't', 'e', 't', 'r', 'y', 'k', ' ', 'i', ' ', 'l', 'ø', 'b',
    'e', 't', ' ', 'a', 'f', ' ', '2', 's', '.', ' ', 'A', 'd', 's', 'k', 'i',
    'l', ' ', 'f', 'ø', 'r', 's', 't', ' ', 'p', 'i', 'n', 'd', 'e', 'n', 'e',
#ifdef TPCAP
    '.', ' ',
#else
    ' ', 'e', 'f', 't', 'e', 'r', ' ', 'b', 'e', 'k', 'r', 'æ', 'f', 't', 'e',
    'l', 's', 'e', 'n', ' ',

    '"', 'A', 'd', 's', 'i', 'l', LCD_CHAR_INSEP, 'p', 'i', 'n', 'd', 'e', 'n',
    'e', '!', '"', ' ', 'o', 'g', ' ', 't', 'i', 'l', 's', 'l', 'u', 't', ' ',

    'f', 'ø', 'r', 's', 't', ' ', 'e', 'f', 't', 'e', 'r', ' ', 'b', 'e', 'k',
    'r', 'æ', 'f', 't', 'e', 'l', 's', 'e', 'n', ' ',
    ...
    'k', 'o', 'n', 'd', 'e', 'n', 's', 'a', 't', 'o', 'r', ' ', 'p', 'å', ' ',
    'm', 'e', 'r', 'e', ' ', 'e', 'n', 'd', ' ', '1', '0', '0', 'n', 'F', ' ',

    'p', 'å', ' ', 'b', 'e', 'n', LCD_CHAR_INSEP, '1', LCD_CHAR_INSEP, '+',
    LCD_CHAR_INSEP, '3', '.', ' ',
#endif
    'S', 'o', 'f', 't', 'w', 'a', 'r', 'e', ' ', 'o', 'g', ' ',

    'd', 'o', 'k', 'u', 'm', 'e', 'n', 't', 'a', 't', 'i', 'o', 'n', ' ', 'e',
    'r', ' ', 'p', 'å', ' ', 's', 'v', 'n', ':', '/', '/', ' ',
