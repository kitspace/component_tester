...
const unsigned char HelpCalibration_str[] PROGMEM = {
    'O', 'n', 'g', 'e', 'c', 'a', 'l', 'i', 'b', 'r', 'e', 'e', 'r', 'd', '!'
#ifndef SHORT_UNCAL_MSG
    ,
    ' ', 'V', 'o', 'o', 'r', LCD_CHAR_INSEP, 'c', 'a', 'l', 'i', 'b', 'r', 'a',
    't', 'i', 'e', ' ',

    'v', 'e', 'r', 'b', 'i', 'n', 'd', ' ', '3', LCD_CHAR_INSEP, 'p', 'i', 'n',
    'n', 'e', 'n', ' ', 'o', 'n', 'd', 'e', 'r', 'l', 'i', 'n', 'g', ' ', 'e',
    'n', ' ',

    's', 't', 'a', 'r', 't', ' ', 'm', 'e', 't', ' ', 'd', 'e', ' ', 't', 'o',
    'e', 't', 's', '.', ' ',

    'B', 'e', 'v', 'e', 's', 't', 'i', 'g', ' ', 'd', 'e', ' ', 'z', 'e', 'l',
    'f', 't', 'e', 's', 't', ' ', 'm', 'e', 't', ' ',

    'd', 'e', ' ', 't', 'o', 'e', 't', 's', ' ', 'i', 'n', ' ', '2', 's', '.',
    ' ', 'S', 'c', 'h', 'e', 'i', 'd', ' ', 'd', 'e', ' ', 'p', 'i', 'n', 'n',
    'e', 'n',
#ifdef TPCAP
    '.', ' ',
#else
    ' ', 'p', 'a', 's', ' ', 'n', 'a', ' ', 'd', 'e', ' ', 'm', 'e', 'l', 'd',
    'i', 'n', 'g', ' ',

    '"', 'S', 'c', 'h', 'e', 'i', 'd', LCD_CHAR_INSEP, 'P', 'i', 'n', 'n', 'e',
    'n', '!', '"', ' ', 'e', 'n', ' ', 's', 'l', 'u', 'i', 't',

    'p', 'a', 's', ' ', 'n', 'a', ' ', 'd', 'e', ' ', 'm', 'e', 'l', 'd', 'i',
    'n', 'g', ' ',
    ...
    'c', 'o', 'n', 'd', 'e', 'n', 's', 'a', 't', 'o', 'r', ' ', 'v', 'a', 'n',
    ' ', 'm', 'e', 'e', 'r', ' ', 'a', 'l', 's', ' ', '1', '0', '0', 'n', 'F',
    ' ',

    'a', 'a', 'n', ' ', 'p', 'i', 'n', LCD_CHAR_INSEP, '1', LCD_CHAR_INSEP, '+',
    LCD_CHAR_INSEP, '3', ' ', 'a', 'a', 'n', '.', ' ',
#endif
    'S', 'o', 'f', 't', 'w', 'a', 'r', 'e', ' ', 'e', 'n', ' ',

    'd', 'o', 'c', 'u', 'm', 'e', 'n', 't', 'a', 't', 'i', 'e', ' ', 's', 't',
    'a', 'a', 't', ' ', 'o', 'p', ' ', 's', 'v', 'n', ':', '/', '/', ' ',
