...
const unsigned char TestRunning[] MEM_TEXT = {'P',  'r',  'o', 'b',  Cz_i,
                                              'h',  Cz_a, ' ', 'm',  Cz_ee,
                                              Cz_r, 'e',  'n', Cz_i, 0};
// const unsigned char BatWeak[] MEM_TEXT = "slabá"; //€€";
const unsigned char BatWeak[] MEM_TEXT = {'s', 'l',  'a',
                                          'b', Cz_a, 0}; // slabá";
...
const unsigned char TestFailed2[] MEM_TEXT = {'v',  'a', 'd', 'n',
                                              Cz_a, ' ', 0}; // vadná";
// const unsigned char Bauteil[] MEM_TEXT = "souèástka"; //€";
const unsigned char Bauteil[] MEM_TEXT = {
    's', 'o', 'u', Cz_c, Cz_a, 's', 't', 'k', 'a', 0}; // souèástka";
...
const unsigned char Unknown[] MEM_TEXT = {' ',  'n', 'e',  'z', 'n',
                                          Cz_a, 'm', Cz_a, 0}; //€";
// const unsigned char TestFailed1[] MEM_TEXT = "Zadná, neznamá"; //€€";
const unsigned char TestFailed1[] MEM_TEXT = {Cz_Z, Cz_a, 'd',  'n', Cz_a,
                                              ' ',  'n',  'e',  'z', 'n',
                                              Cz_a, 'm',  Cz_a, 0}; //€€";
//   const unsigned char OrBroken[] MEM_TEXT = {'n','e','b','o','
//   ','v','a','d','n',Cz_a,' ',0}; //€€";
const unsigned char Detected[] MEM_TEXT = {
    ' ', 'd', 'e', 't', 'e', 'k', 'o', 'v', Cz_a, 'n', 'a'}; // " detekována"
...
const unsigned char RotaryEncoder_str[] MEM2_TEXT = {
    'R', 'o', 't', 'a', Cz_c, 'n', Cz_i, ' ', 'k', 'o', 'd', Cz_e, 'r', 0};
#endif
const unsigned char SetCapCorr_str[] MEM2_TEXT = {
    'C', '(', LCD_CHAR_U, 'F', ')', '-', 'k', 'o', 'r', 'e', 'k', 'c', 'e', 0};
// const unsigned char TURN_str[] MEM2_TEXT = "otoète!";
const unsigned char TURN_str[] MEM2_TEXT = {'o', 't', 'o', Cz_c,
                                            't', 'e', '!', 0};
...
const unsigned char HelpCalibration_str[] PROGMEM = {
    'N', 'e', 'z', 'k', 'a', 'l', 'i', 'b', 'r', 'o', 'v', Cz_a, 'n', 'o', '!'
#ifndef SHORT_UNCAL_MSG
    ,
    ' ', 'P', 'r', 'o', LCD_CHAR_INSEP, 'K', 'a', 'l', 'i', 'b', 'r', 'a', 'c',
    'i', ' ',

    'z', 'k', 'r', 'a', 't', 'u', 'j', ' ', 'v', Cz_s, 'e', 'c', 'h', 'n', 'y',
    ' ', '3', ' ', 'm', Cz_ee, Cz_r, Cz_i, 'c', Cz_i, ' ', 'b', 'o', 'd', 'y',
    ' ', 'a', ' ',

    's', 'p', 'u', 's', Cz_t, ' ', 's', 't', 'i', 's', 'k', 'e', 'm', ' ', 'T',
    'E', 'S', 'T', LCD_CHAR_INSEP, 't', 'l', 'a', Cz_c, Cz_i, 't', 'k', 'a',
    ' ',

    'K', 'a', 'l', 'i', 'b', 'r', 'a', 'c', 'i', ' ', 'a', 'k', 't', 'i', 'v',
    'u', 'j', ' ', 'd', 'a', 'l', Cz_s, Cz_i, 'm', ' ', 's', 't', 'i', 's', 'k',
    'e', 'm', ' ',

    't', 'l', 'a', Cz_c, Cz_i, 't', 'k', 'a', ' ', 'v', ' ', 'd', 'o', 'b',
    Cz_ee, ' ', 'k', 'r', 'a', 't', Cz_s, Cz_i, ' ', '2', LCD_CHAR_INSEP, 's',
    'e', 'k', 'u', 'n', 'd', ' ',
    ...
    'O', 'd', 's', 't', 'r', 'a', Cz_n, ' ', 'z', 'k', 'r', 'a', 't', ' ', 'm',
    Cz_ee, Cz_r, Cz_i, 'c', Cz_i, 'c', 'h', ' ', 'b', 'o', 'd', Cz_uu, ' ',

    'P', Cz_r, 'i', ' ', 'z', 'o', 'b', 'r', 'a', 'z', 'e', 'n', Cz_i, ' ', '"',
    '1' + TP_OFFSET, LCD_CHAR_LINE1, LCD_CHAR_CAP, LCD_CHAR_LINE1,
    '3' + TP_OFFSET, LCD_CHAR_INSEP, '>', '1', '0', '0', 'n', 'F', '"', ' ',

    'v', LCD_CHAR_INSEP, 'd', 'a', 'l', Cz_s, Cz_i, 'm', ' ', 'k', 'r', 'o',
    'k', 'u', ' ', 'k', 'a', 'l', 'i', 'b', 'r', 'a', 'c', 'e', ' ', 'p', Cz_r,
    'i', 'p', 'o', 'j', ' ', 'k', 'v', 'a', 'l', 'i', 't', 'n', Cz_i, ' ', 'k',
    'o', 'n', 'd', Cz_i, 'k', ' ', 'v', 'e', 't', Cz_s, Cz_i, ' ', 'j', 'a',
    'k', ' ',

    '1', '0', '0', 'n', 'F', LCD_CHAR_INSEP, 'm', 'e', 'z', 'i', ' ', 'b', 'o',
    'd', 'y', ' ', '1', 'a', '3', ' ', 'A', 'V', 'R', ' ', 't', 'e', 's', 't',
    'e', 'r', 'u', ' ', 'v', LCD_CHAR_INSEP, 'p', 'o', 's', 'l', 'e', 'd', 'n',
    Cz_i, 'm', ' ',

    'k', 'r', 'o', 'k', 'u', ' ', 'k', 'a', 'l', 'i', 'b', 'r', 'a', 'c', 'e',
    ' ', 'p', Cz_r, 'i', 'p', 'o', 'j', ' ', 'k', 'o', 'n', 'd', Cz_i, 'k', ' ',
    '1', '0', '-', '3', '0', 'n', 'f', ' ', 'p', 'a', 'k', ' ', 'h', 'o', ' ',
    'p', 'o', 'u', Cz_z, 'i', 'j', ' ', 'p', 'a', 'r', 'a', 'l', 'e', 'l', 'n',
    Cz_ee, ' ', 'j', 'a', 'k', 'o', ' ', 'r', 'e', 'z', 'o', 'n', 'a', 'n',
    Cz_c, 'n', Cz_i, ' ', 'p', 'r', 'o', ' ', 'm', Cz_ee, Cz_r, 'e', 'n', Cz_i,
    ' ', 'v', 'e', 'l', 'k', Cz_y, 'c', 'h', ' ', 'c', Cz_i, 'v', 'e', 'k', ' ',

    'd', 'a', 'l', Cz_s, Cz_i, ' ', 'i', 'n', 'f', 'o', 'r', 'm', 'a', 'c', 'e',
    ' ', 'o', ' ', 's', 'o', 'f', 't', 'w', 'a', 'r', 'e', ' ', 'a', ' ',

    'd', 'o', 'k', 'u', 'm', 'e', 'n', 't', 'a', 'c', 'e', ' ', 'n', 'a', ' ',
    ' ', 's', 'v', 'n', ':', '/', '/', ' ',
