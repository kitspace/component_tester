...
const unsigned char bmp_vakdiode[(7 * 4) + 4] PROGMEM = {
    ...
    0x04, 0x04, 0x04, 0xFC, 0x00, 0x00, 0x00, 0x20, 0x60, 0xE0,
    0xFF, 0xE0, 0x60, 0x20, 0x02, 0x02, 0x02, 0xFF, 0x02, 0x02,
    0x02, 0x20, 0x20, 0x20, 0x3F, 0x00, 0x00, 0x00,
};
#elif (ICON_TYPE == 3)
const unsigned char bmp_vakdiode[(7 * 4) + 4] PROGMEM = {
    24,   0,
    7,  // The width of the bitmap.
    32, // The height of the bitmap.
    0x08, 0x08, 0x08, 0xF8, 0x00, 0x00, 0x00, 0x20, 0x60, 0xA0,
    0x3F, 0xA0, 0x60, 0x20, 0x02, 0x02, 0x02, 0xFF, 0x02, 0x02,
    0x02, 0x10, 0x10, 0x10, 0x1F, 0x00, 0x00, 0x00,
};
...
const unsigned char bmp_vakdiode[(8 * 4) + 4] PROGMEM = {
    ...
    32, // The height of the bitmap.
    0x06, 0x06, 0x06, 0xFE, 0xFE, 0x00, 0x00, 0x00, 0x20, 0x60, 0xE0,
    0xFF, 0xFF, 0xE0, 0x60, 0x20, 0x06, 0x06, 0x06, 0xFF, 0xFF, 0x06,
    0x06, 0x06, 0x60, 0x60, 0x60, 0x7F, 0x7F, 0x00, 0x00, 0x00,
};
#endif
#else
...
#if (LCD_ST_TYPE == 7920)
#if defined(MAIN_C)
const unsigned char set_msk[] PROGMEM = {0x01, 0x02, 0x04, 0x08,
                                         0x10, 0x20, 0x40, 0x80};
const unsigned char clear_msk[] PROGMEM = {0xfe, 0xfd, 0xfb, 0xf7,
                                           0xef, 0xdf, 0xbf, 0x7f};
#else
